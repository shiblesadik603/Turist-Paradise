...
- Redis (optional — `brew install redis && brew services start redis` locally, or point `REDIS_URL` at a hosted instance). Without it, caching just skips itself; nothing breaks.
