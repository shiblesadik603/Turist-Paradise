...
/** Grid of a user's saved AI trip plans, with a click-through "view details" modal. Embedded on the profile page. */
export const SavedTrips = () => {
  ...
  useEffect(() => {
    ...
    plannerApi
      .getTripPlans(userId)
      .then((response) => setSavedPlans(response.data.data))
        ...
        <div className="modal-overlay" onClick={handleClose}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <TripPlanDetails plan={selectedPlan} />
            </div>
          </div>
        </div>
      )}
