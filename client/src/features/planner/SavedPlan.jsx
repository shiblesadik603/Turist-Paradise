      ...
      <div className="saved-plans-card">
        {savedPlans.length === 0 ? (
          <div className="empty-state">
            ...
            <p>
              Start creating your travel plans to see them here. Generate your first adventure and
              ...
              <div className="modal-body">
                <div className="modal-stats">
                  <div className="modal-stat">
                    <span className="modal-stat__icon">
                      <svg viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zM7 10h5v5H7z" />
                      </svg>
                    </span>
                    <span className="modal-stat__label">Duration</span>
                    <span className="modal-stat__value">{selectedPlan.duration}</span>
                  </div>
                  <div className="modal-stat">
                    <span className="modal-stat__icon">
                      <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <span className="modal-stat__label">Travelers</span>
                    <span className="modal-stat__value">{selectedPlan.travelers}</span>
                  </div>
                  <div className="modal-stat">
                    <span className="modal-stat__icon">
                      <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <span className="modal-stat__label">Budget</span>
                    <span className="modal-stat__value">{selectedPlan.budget}</span>
                  </div>
                </div>
